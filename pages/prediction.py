...
st.caption(
    ...
    "AI predictive engine estimating equipment failure probability from live sensor intelligence."
...
if critical == 0:
    ...
    st.error(
        ...
        "AI detected multiple critical machines. Immediate maintenance planning is recommended."
